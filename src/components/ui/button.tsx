...
const base =
  "inline-flex items-center justify-center gap-2 rounded-full px-6 py-[15px] text-sm font-medium leading-none transition-[background-color,transform] duration-200 active:scale-[0.97] cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 disabled:pointer-events-none";
